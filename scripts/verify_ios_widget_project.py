...
require('<string>SelectTimetable</string>' in intent_definition_text and '<string>INObject</string>' in intent_definition_text, "Intent definition generates SelectTimetableIntent with an INObject parameter")
...
require('INObjectCollection<INObject>' in intent_swift and 'INObject(identifier:' in intent_swift, "Intent handler uses generated INObject parameter options")
