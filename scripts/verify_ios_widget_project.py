...
require('SelectTimetable.intentdefinition in Sources' in pbx and 'IntentDefinitionCompile' not in intent_resources, "Intent definition is compiled as source for code generation")
