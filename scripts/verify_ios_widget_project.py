...
require("Assemble and verify complete unsigned iOS app" in workflow, "release workflow assembles a complete unsigned Runner.app")
require('test -x "$RUNNER_APP/Runner"' in workflow and 'test -s "$RUNNER_APP/Frameworks/App.framework/App"' in workflow, "release workflow rejects an incomplete Runner executable")
