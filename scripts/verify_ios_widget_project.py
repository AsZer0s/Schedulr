...
require('INTENTS_CODEGEN_LANGUAGE = Automatic' in pbx, "Intent targets enable automatic code generation")
require('Intents.framework in Frameworks' in pbx, "Intent extension links Intents.framework")
require('<string>SelectTimetable</string>' in intent_definition_text and '<key>INIntentParameterObjectType</key>\n\t\t\t\t\t<string>Timetable</string>' in intent_definition_text and '<key>INIntentParameterObjectTypeNamespace</key>\n\t\t\t\t\t<string>SchedulrIntents</string>' in intent_definition_text and '<key>INIntentParameterType</key>\n\t\t\t\t\t<string>Object</string>' in intent_definition_text, "Intent definition uses a namespaced custom Timetable object parameter")
require('<key>INTypeName</key>\n\t\t\t<string>Timetable</string>' in intent_definition_text and all(name in intent_definition_text for name in ['<string>identifier</string>', '<string>displayString</string>']), "Intent definition generates the Timetable object type")
require('SelectTimetable.intentdefinition in Sources' in object_block(pbx, "A10000000000000000000014"), "Widget target generates intent types from the definition")
